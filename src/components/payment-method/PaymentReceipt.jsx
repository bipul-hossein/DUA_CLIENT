            ...
            <div className="max-w-full p-4 bg-white shadow-md rounded">
                <div className="receipt-container w-full p-6 bg-white shadow-md rounded" id="receipt" style={{ fontSize: '12px' }}>
                    <div className="receipt-header text-center mb-6">
                        <h1 className="text-3xl font-bold text-black" style={{ fontSize: '24px' }}>Payment Receipt</h1>
                        <p style={{ fontSize: '14px', color: '#555' }}>This receipt has been generated electronically.</p>
                    </div>
                    <div className="receipt-section mb-6">
                        <h2 className="text-lg font-semibold text-black" style={{ fontSize: '18px' }}>Bill Information</h2>
                        <div className="receipt-item flex justify-between mb-3 text-black" style={{ fontSize: '12px' }}>
                    ...
                    <div className="receipt-section mb-6">
                        <h2 className="text-lg font-semibold text-black" style={{ fontSize: '18px' }}>Payment Information</h2>
                        <div className="receipt-item flex justify-between mb-3 text-black" style={{ fontSize: '12px' }}>
                    ...
                    <div className="receipt-total font-bold mt-6 text-black" style={{ fontSize: '14px' }}>
                        Total: BDT 696.0
                    </div>
                </div>
                <button
                    onClick={generatePDF}
                    className="download-btn w-full mt-6 py-2 bg-blue-500 text-white font-semibold rounded"
                >
                    Download PDF
                </button>
            </div>
